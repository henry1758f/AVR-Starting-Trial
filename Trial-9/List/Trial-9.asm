...
; 0000 0026 char A=false,B=false;
; 0000 0027 unsigned char R;
...
; 0000 003C // Func7=In Func6=Out Func5=In Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 003D // State7=T State6=1 State5=T State4=T State3=T State2=T State1=T State0=T
; 0000 003E PORTD=0x40;
	LDI  R30,LOW(64)
	OUT  0x12,R30
; 0000 003F DDRD=0x40;
	OUT  0x11,R30
...
; 0000 006D TIMSK=0x00;
	OUT  0x39,R30
; 0000 006E 
; 0000 006F // UART initialization
; 0000 0070 // Communication Parameters: 8 Data, 1 Stop, No Parity
; 0000 0071 // UART Receiver: On
; 0000 0072 // UART Transmitter: On
; 0000 0073 // UART Baud Rate: 9600
; 0000 0074 UCR=0x18;
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 0075 UBRR=0x33;
...
; 0000 0089                 TXdata('A');
	LDI  R26,LOW(65)
	RCALL _TXdata
; 0000 008A                 while(!(RXdata()=='C'));
_0x9:
	RCALL _RXdata
	CPI  R30,LOW(0x43)
	BRNE _0x9
; 0000 008B                 PORTB.PORTB0=1;
	SBI  0x18,0
; 0000 008C                 A=true;
	LDI  R16,LOW(1)
; 0000 008D             }
...
; 0000 0092                 TXdata('B');
	LDI  R26,LOW(66)
	RCALL _TXdata
; 0000 0093                 while(!(RXdata()=='D'));
_0x11:
	RCALL _RXdata
	CPI  R30,LOW(0x44)
	BRNE _0x11
; 0000 0094                 PORTB.PORTB1=1;
	SBI  0x18,1
; 0000 0095                 B=true;
	LDI  R17,LOW(1)
; 0000 0096             }
...
; 0000 00A4 {
_RXdata:
; 0000 00A5     unsigned char data;
; 0000 00A6 
; 0000 00A7     while(USR.RXC==0);
	ST   -Y,R16
;	data -> R16
_0x1D:
	SBIS 0xB,7
